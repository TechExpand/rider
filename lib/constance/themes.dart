...
class CoustomTheme {
  ...
  static TextTheme _buildTextTheme(TextTheme base) {
    return base.copyWith(
      headline4  : GoogleFonts.montserrat(textStyle: TextStyle(color: base.headline4!.color, fontSize: 20, fontWeight: FontWeight.w500)),
      headline5 : GoogleFonts.montserrat(textStyle: TextStyle(color: base.headline5!.color, fontSize: 16)),
      subtitle1 : GoogleFonts.montserrat(textStyle: TextStyle(color: base.subtitle1!.color, fontSize: 14, fontWeight: FontWeight.w500)),
      bodyText1 : GoogleFonts.montserrat(textStyle: TextStyle(color: base.bodyText1!.color, fontSize: 16)),
      bodyText2: GoogleFonts.montserrat(textStyle: TextStyle(color: base.bodyText2!.color, fontSize: 14)),
      ...
      display4: GoogleFonts.montserrat(textStyle: TextStyle(color: base.display4.color, fontSize: 96)),
          **/
      headline3: GoogleFonts.montserrat(textStyle: TextStyle(color: base.headline3!.color, fontSize: 24)),
